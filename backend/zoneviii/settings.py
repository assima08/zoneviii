...
SERVE_MEDIA_FILES = os.getenv("SERVE_MEDIA_FILES", "False") == "True"
...
GOOGLE_CALENDAR_TIMEOUT_SECONDS = int(os.getenv("GOOGLE_CALENDAR_TIMEOUT_SECONDS", "5"))
ENABLE_GOOGLE_CALENDAR_SYNC = env_bool("ENABLE_GOOGLE_CALENDAR_SYNC", default=True)
ENABLE_RESERVATION_EMAIL_NOTIFICATION = env_bool(
    "ENABLE_RESERVATION_EMAIL_NOTIFICATION",
    default=True,
)
